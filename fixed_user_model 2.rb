...
# Fixed User model with INDIAN_STATES constant moved to the top
fixed_user_model = <<~RUBY
...
File.write('/rails/app/models/user.rb', fixed_user_model)
puts "✅ User model fixed successfully! INDIAN_STATES constant moved to top."
